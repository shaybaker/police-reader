...
המתקין ייווצר בתיקיית `dist`. במהלך ההתקנה מסומן כברירת מחדל ליצור קיצור דרך על שולחן העבודה ובתפריט Start. אם Windows מציג אזהרת SmartScreen, בחרו `More info` ואז `Run anyway`. אם המתקין עדיין נחסם, הורידו את קובץ ה־Portable מאותו Release והפעילו אותו ללא התקנה.
...
- מסלול ארוך של 24 אתגרים: 8 קריאה, 8 כתיבה ו־8 זיהוי צלילים, עם מעבר אוטומטי בין משימות.
- בגרסה המורחבת יש 24 אתגרים, נעילת חזרה לאותו סשן, ארכיון תמונות אינטראקטיבי ודרגות: מתלמד, בלש מתחיל, בלש זוטר, בלש מתקדם ומפקד חקירה.
- תמונות חיצוניות ממקורות Wikimedia Commons נטענות לפי הצורך, עם fallback מקומי כשהמחשב ללא אינטרנט.
